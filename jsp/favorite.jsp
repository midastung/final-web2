                                            ...
                                            while(tmp.next())
                                            {
                                                   out.println("<div class='single-product p-3'>");
                                                    out.println("<div class='product-img'>");
                                                        ...
                                                        out.println("<a href='del_favorite.jsp?love_id="+tmp.getString("love_id")+"'"+"data-toggle='tooltip' data-placement='top' title='trash'>"+"<i class='fas fa-trash-alt fa-2x'></i>"+"</a>");
