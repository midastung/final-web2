...
<%
			 ...
			 String sql2="select * from shopping_cart,product where m_account='"+acc+"' and shopping_cart.p_id=product.p_id='"+p_id+"'";
            ...
            if(a.next()){
                ...
                con.createStatement().execute(sql);
                out.write("<script language=javascript>alert('成功將「"+a.getString("p_name")+"x"+q+"」加入購物車!');</script>");
